...
import { useUpdate } from './useKaryawan';

const steps = ['Akun', 'Detail Karyawan'];

const addkaryawanForm = ({id}) => {
    const router = useRouter();
    const { formik, role, handleChange, activeStep, setActiveStep } = useUpdate(id);

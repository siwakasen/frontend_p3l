...
import { useInsert } from './useResep';
...
const AddResepForm = () => {
    ...
    const { formik, data, bahanBaku, handleChangeBahanBaku, handleChangeJumlah, handleAddField, handleRemoveField, numberOfField, handleCheck, handleSubmit } = useInsert();

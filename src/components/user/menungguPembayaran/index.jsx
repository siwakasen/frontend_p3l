...
import ContainerMenungguPembayaran from './ContainerMenungguPembayaran';
                ...
                <Grid item xs={12} sm={12} md={3} lg={3}>
                    <Box item="true" borderRadius={2} boxShadow={1} bgcolor="#fff" border={"1px solid #f0f0f0"}>
                        <List>
                            <ListItem>
                                <Avatar />
                                <Typography sx={{ marginLeft: 1 }} fontWeight={600} variant="subtitle1">
                                    {data.user.nama}
                                </Typography>
                            </ListItem>
                        </List>
                        <List>
                            <ListItem sx={{ display: 'flex', justifyContent: 'space-between' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    ...
                                    <Typography sx={{ marginLeft: 1 }} fontWeight={600} variant="subtitle1">Saldo</Typography>
                                </Box>
                                <Typography sx={{ marginLeft: 1 }} fontWeight={600} variant="subtitle1">
                        ...
                        <List>
                            <ListItem sx={{ display: 'flex', justifyContent: 'space-between' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    ...
                                    <Typography sx={{ marginLeft: 1 }} fontWeight={600} variant="subtitle1">Poin</Typography>
                                </Box>
                                <Typography sx={{ marginLeft: 1 }} fontWeight={600} variant="subtitle1">
                                    {data.user.poin}
                                </Typography>
